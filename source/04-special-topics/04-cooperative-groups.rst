...
完整的 Cooperative Groups API 可在 :doc:`../../05-appendices/06-device-callable-apis` 中的 Cooperative Groups API 章节找到。
...
完整的成员函数列表可在 :doc:`../../05-appendices/06-device-callable-apis` 中的 Cooperative Groups API 章节找到。
...
更多信息可在 :doc:`../../05-appendices/06-device-callable-apis` 中的 Cooperative Groups API 章节找到。
...
最佳划分策略取决于上下文。更多信息可在 :doc:`../../05-appendices/06-device-callable-apis` 中的 Cooperative Groups API 章节找到。
...
有关同步的更多信息可在 :doc:`../../05-appendices/06-device-callable-apis` 中的 Cooperative Groups API 章节找到。
...
组中的所有线程必须为每个集合调用的相应参数传递相同的值，除非在 :doc:`../../05-appendices/06-device-callable-apis` 中的 Cooperative Groups API 章节中明确允许不同的值。否则，调用的行为是未定义的。
...
有关归约的更多信息可在 :doc:`../../05-appendices/06-device-callable-apis` 中的 Cooperative Groups API 章节找到。
...
有关 scan 的更多信息可在 :doc:`../../05-appendices/06-device-callable-apis` 中的 Cooperative Groups Scan API 章节找到。
...
有关更多信息，请参阅 :doc:`../../05-appendices/06-device-callable-apis` 中的 Cooperative Groups API 章节。
